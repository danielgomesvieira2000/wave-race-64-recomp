...
```
powershell -ExecutionPolicy Bypass -File tools/package_release.ps1 -BuildDir build-fe -Version 1.0.0
python3 tools/package_release.py --version 1.0.0
```
...
python3 tools/package_release.py --version 1.0.0 --build-dir build-macos-release
```
