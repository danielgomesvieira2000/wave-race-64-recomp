...
#ifndef WR64_VERSION
#   define WR64_VERSION "unknown"
#   define WR64_VERSION_MAJOR 0
#   define WR64_VERSION_MINOR 0
#   define WR64_VERSION_PATCH 0
#endif
...
void print_version() {
    std::printf("Wave Race 64: Recompiled %s\n", WR64_VERSION);
...
int run(int argc, char** argv, const char* rom_arg) {
    ...
    config.project_version =
        recomp::Version{ WR64_VERSION_MAJOR, WR64_VERSION_MINOR, WR64_VERSION_PATCH, "" };
    wr64::inspector::init();
